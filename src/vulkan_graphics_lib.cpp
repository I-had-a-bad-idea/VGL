...
Renderer create_renderer(std::string name, int w, int h) {
    ...
    VkSurfaceKHR surface = create_vulkan_surface_for_window(instance, window);
    VkSurfaceCapabilitiesKHR surface_caps = get_surface_properties(devices, physical_device.device_index, surface);
